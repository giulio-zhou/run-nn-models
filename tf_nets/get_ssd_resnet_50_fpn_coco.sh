...
prog() {
    ...
    wget http://download.tensorflow.org/models/object_detection/ssd_resnet_50_fpn_coco_2018_07_03.tar.gz
    ...
    mv ssd_resnet50_v1_fpn_shared_box_predictor_640x640_coco14_sync_2018_07_03 ssd_resnet_50_fpn_coco
